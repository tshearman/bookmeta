...
def _serialize_context_limits(limits: ContextLimits | None) -> dict[str, Any]:
    if limits is None:
        return {}
    return {
...
def serialize_pipeline_config(config: Any) -> dict[str, Any]:
    return {
        ...
        "extraction_config": {
            ...
            "context_limits": _serialize_context_limits(
                config.extraction_config.context_limits
            ),
            "prompt": config.extraction_config.prompt,
        },
        "selection_config": {
            ...
            "context_limits": _serialize_context_limits(
                config.selection_config.context_limits
            ),
        },
        "booksearch_config": {
            "search_methods": [
