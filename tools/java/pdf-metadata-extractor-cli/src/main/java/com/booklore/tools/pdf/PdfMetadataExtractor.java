...
/**
 * Standalone copy of the PdfMetadataExtractor logic so the CLI can be
 * executed without running the full Spring Boot application.
 */
public class PdfMetadataExtractor implements FileMetadataExtractor {
    ...
    public BookMetadata extractMetadata(File file) {
        ...
        BookMetadata.Builder metadataBuilder = BookMetadata.builder();
    ...
    private void extractDublinCoreMetadata(XPath xpath, Document doc, BookMetadata.Builder builder) throws XPathExpressionException {
    ...
    private void extractCalibreMetadata(XPath xpath, Document doc, BookMetadata.Builder builder) {
        try {
    ...
    private Map<String, String> extractIdentifiers(XPath xpath, Document doc) throws XPathExpressionException {
        ...
        NodeList idNodes = (NodeList) xpath.evaluate("//xmp:Identifier/rdf:Bag/rdf:li", doc, XPathConstants.NODESET);
